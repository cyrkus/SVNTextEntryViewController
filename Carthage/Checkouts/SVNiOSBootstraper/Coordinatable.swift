...
open class Coordinator<T>: UIResponder, Coordinating {
  ...
  /// pops to the rootViewController
  /// notifies parent of coordinator dismissal
  public func pop(toRootViewController rootViewController: UINavigationController, animated: Bool){
